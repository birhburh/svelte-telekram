...
<div class="kai-range-slider-content">
  ...
  <div class="kai-range-slider-body">
    ...
    <div
      class="kai-range-slider-loaded"
      style="width:calc({progress}%);border-radius:4px 0px 0px 4px;"
    ></div>
...
<style>
  ...
  .kai-range-slider-content
    > .kai-range-slider-body
    > .kai-range-slider-track-shadow {
    width: calc(100% + 22px);
    background-color: #cccccc;
    height: 8px;
    border-radius: 4px;
